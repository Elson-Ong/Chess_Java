...
public class CheckScanner {
    ...
    private boolean checkKnight(Piece p, Piece k, int col, int row){
        return p != null && !board.sameTeam(k,p) && p.getName().equals("Knight") && !(p.getCol() == col && p.getRow() == row);
    }
    ...
    private boolean checkKing(Piece p, Piece k){
        return p != null && !board.sameTeam(k,p) && p.getName().equals("King");
    }
    ...
    private  boolean checkPawn(Piece p, Piece k, int col, int row){
        return p!= null && !board.sameTeam(k,p) && p.getName().equals("Pawn") && !(p.getCol() == col && p.getRow() == row);
    }
